...
part of 'sausage_roll_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SausageRollModel _$SausageRollModelFromJson(Map<String, dynamic> json) =>
    SausageRollModel(
...
Map<String, dynamic> _$SausageRollModelToJson(SausageRollModel instance) =>
    <String, dynamic>{
